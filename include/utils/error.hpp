...
[[nodiscard]] inline std::string_view error_kind_str(ErrorKind k) noexcept {
  ...
  case ErrorKind::Unknown:
    return "Unknown";
  case ErrorKind::ElementCreation:
    return "ElementCreation";
  case ErrorKind::ElementLink:
    return "ElementLink";
  case ErrorKind::ElementState:
    return "ElementState";
  case ErrorKind::NoElements:
    return "NoElements";
  case ErrorKind::DuplicateName:
    return "DuplicateName";
  case ErrorKind::IncompatibleCaps:
    return "IncompatibleCaps";
  case ErrorKind::PipelineCreation:
    return "PipelineCreation";
  case ErrorKind::BinAdd:
    return "BinAdd";
  case ErrorKind::ParseLaunch:
    return "ParseLaunch";
  }
  return "Unknown";
}
...
struct Error {
  ...
  [[nodiscard]] std::size_t find(std::string_view s, std::size_t pos = 0) const noexcept {
    return message.find(s, pos);
  }
  ...
  friend bool operator==(std::string_view s, const Error& e) noexcept {
    return e.message == s;
  }
  friend bool operator!=(std::string_view s, const Error& e) noexcept {
    return e.message != s;
